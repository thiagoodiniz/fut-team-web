    ...
    <Space direction="vertical" size={24} style={{ width: '100%' }}>
      ...
      {stats && (
        <>
          ...
          <Row gutter={[16, 16]}>
            ...
            <Col span={24}>
              <Card
                title={
                  <>
                    <TeamOutlined style={{ color: token.colorPrimary, marginRight: 8 }} />{' '}
                    Mais Jogos (Top 5)
                  </>
                }
                style={{ borderRadius: 12 }}
          ...
          {/* Histórico de Confrontos */}
          <Title level={5} style={{ margin: '8px 0 -8px 0' }}>
            Histórico de Confrontos
          </Title>
          <Row gutter={[16, 16]}>
            <Col span={24}>
            ...
            <Col span={24}>
              <Card style={{ borderRadius: 12 }} bodyStyle={{ padding: 16 }}>
                ...
                {stats.topScoringOpponents.length === 0 && (
                  <Empty
                    image={Empty.PRESENTED_IMAGE_SIMPLE}
                    description="Nenhum adversário"
                  />
            ...
            <Col span={24}>
              <Card style={{ borderRadius: 12 }} bodyStyle={{ padding: 16 }}>
                ...
                {stats.topConcedingOpponents.length === 0 && (
                  <Empty
                    image={Empty.PRESENTED_IMAGE_SIMPLE}
                    description="Nenhum adversário"
                  />
