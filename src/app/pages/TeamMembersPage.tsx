    ...
    <List
      ...
      renderItem={(member) => (
        ...
        >
          ...
          >
            <Avatar size={54} src={member.user.avatarUrl}>
              {member.user.name[0]}
            </Avatar>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <Text
                type="secondary"
                style={{ display: 'block', wordBreak: 'break-all', fontSize: 14 }}
              >
                {member.user.email}
              </Text>
            </div>
    ...
    <List
      ...
      renderItem={(req) => (
        ...
        >
          ...
          >
            <Avatar size={54} src={req.user.avatarUrl}>
              {req.user.name[0]}
            </Avatar>
            <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            <Button
              ...
              onClick={() => {
                posthog.capture('request_responded', {
                  requestId: req.id,
                  action: 'APPROVE',
                })
